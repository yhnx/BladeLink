...
class Telelink_reciever(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Telelink_reciever")
...
def main(top_block_cls=Telelink_reciever, options=None):
    if options is None:
