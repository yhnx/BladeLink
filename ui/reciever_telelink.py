    ...
    def show(self):
        ...
        def process_and_store_file():
            ...
            try:
                ...
                with open(self.selected_save_path, "wb") as file:
                    file.write(content)
...
class MainApp:
    ...
    def start_receiving(self):
        # Start Telelink_receiver.py in a subprocess
        def run_receiver():
            try:
                subprocess.run(["python3", "Telelink_reciever.py"], check=True)
                messagebox.showinfo("Execution Complete", "File recieved successfully.")
    ...
    def show_start_screen(self):
        ...
        # Heading
        heading = tk.Label(self.root, text="Telelink Receiver", font=("Arial", 20))
        heading.pack(pady=20)

        # Start Receiving button
        start_button = ttk.Button(self.root, text="Start Receiving", command=self.start_receiving, width=20, style="Custom.TButton")
        start_button.pack(pady=20)

    def show_receiver_frame(self):
        receiver_frame = ReceiverFrame(self.root, self.show_start_screen)
        receiver_frame.show()
