...
class CDP_BACKUP(gr.top_block, Qt.QWidget):

    def __init__(self, MTU=1500):
        gr.top_block.__init__(self, "CDP_BACKUP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CDP_BACKUP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "CDP_BACKUP")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/praveen/Desktop/project/files/minimovie.ts', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/praveen/Documents/git/CDP/source_files/out.ts', False)
...
def main(top_block_cls=CDP_BACKUP, options=None):
    if options is None:
