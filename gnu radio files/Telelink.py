...
class Telelink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/praveen/video1.ts', False, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_throttle2_2, 0))
        ...
        self.connect((self.blocks_throttle2_2, 0), (self.blocks_add_xx_0, 0))
