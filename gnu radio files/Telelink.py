...
class Telelink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.hdr_format = hdr_format = digital.header_format_default('101010101010101011111',1, 1)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._con_range = qtgui.Range(0, 1, 0.01, 0.5, 200)
        self._con_win = qtgui.RangeWidget(self._con_range, self.set_con, "'con'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._con_win)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(con)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/praveen/Desktop/cdp/EN2130_Communication_Design_Project/source_files/text.txt', True, 0, 0)
    ...
    def set_con(self, con):
        self.con = con
        self.blocks_multiply_const_vxx_0.set_k(self.con)
