...
class yehen_try_qpsk(gr.top_block, Qt.QWidget):

    def __init__(self, MTU=3000, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "yehen_try_qpsk")
        ...
        self.pack_len = pack_len = 16
        self.nfilts = nfilts = 32
        self.k = k = 7
        self.bpsk = bpsk = digital.constellation_bpsk().base()
        self.bpsk.set_npwr(0)
        ...
        self.header_format = header_format = digital.header_format_default('0001111011010001',0, 1)
        self.freq_offset = freq_offset = 0.05
        self.freq = freq = 433e6
        self.excess_bw = excess_bw = 0.5
        self.eq_gain = eq_gain = 0.01
        self.enc_cc = enc_cc = fec.cc_encoder_make((pack_len*8),k, rate, polys, 0, fec.CC_TERMINATED, False)
        self.delay = delay = 50
        self.dec_cc = dec_cc = list(map( (lambda a: fec.cc_decoder.make((pack_len*8),k, rate, polys, 0, (-1), fec.CC_TERMINATED, False)),range(0,1)))
        self.arity = arity = 4
        ...
        for c in range(0, 1):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._time_offset_range = qtgui.Range(0.999, 1.08, 0.0001, 1.00, 200)
        ...
        self.soapy_bladerf_source_0.set_frequency(0, rx_freq_)
        ...
        self.soapy_bladerf_sink_0.set_bandwidth(0, 1)
        self.soapy_bladerf_sink_0.set_frequency(0, 433e6)
        ...
        self.received_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_1_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self._noise_volt_range = qtgui.Range(0, 1, 0.01, 0.1, 200)
        ...
        self._freq_offset_range = qtgui.Range(-0.1, 0.1, 0.1, 0.05, 200)
        ...
        self.fec_extended_tagged_decoder_2_0 = self.fec_extended_tagged_decoder_2_0 = fec_extended_tagged_decoder_2_0 = fec.extended_tagged_decoder(decoder_obj_list=dec_cc, ann=None, puncpat='11', integration_period=10000, lentagname="out", mtu=MTU)
        ...
        self.digital_correlate_access_code_xx_ts_0 = digital.correlate_access_code_bb_ts('0001111011010001',
          0, 'out')
        ...
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(1, 8, 'out', False, gr.GR_MSB_FIRST)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/praveen/Desktop/project/files/bunny.png', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/praveen/Desktop/temp.png', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0_0_0 = blocks.delay(gr.sizeof_float*1, delay)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, 58)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_char_to_float_0_0_0_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_char_to_float_0_0_0_0_0, 0), (self.blocks_delay_0_0_0, 0))
        self.connect((self.blocks_char_to_float_0_0_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_char_to_float_0_0_1_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.blocks_char_to_float_1_1, 0), (self.fec_extended_tagged_decoder_2_0, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 1))
        self.connect((self.blocks_delay_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 1))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_0_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.blocks_char_to_float_0_0_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_0, 0), (self.blocks_char_to_float_0_0_0_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_0_0, 0), (self.blocks_char_to_float_0_0_1_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_1, 0), (self.blocks_char_to_float_0_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_1, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0_0, 0), (self.blocks_char_to_float_0_1, 0))
        ...
        self.connect((self.digital_correlate_access_code_xx_ts_0, 0), (self.digital_map_bb_0_0_0, 0))
        ...
        self.connect((self.digital_map_bb_0_0_0, 0), (self.blocks_char_to_float_1_1, 0))
        self.connect((self.digital_protocol_formatter_bb_0, 0), (self.blocks_tagged_stream_mux_0, 0))
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.digital_costas_loop_cc_0_0, 0))
        self.connect((self.fec_extended_tagged_decoder_2_0, 0), (self.blocks_repack_bits_bb_0, 0))
    ...
    def set_rx_freq_(self, rx_freq_):
        ...
        self.soapy_bladerf_source_0.set_frequency(0, self.rx_freq_)
...
def argument_parser():
    ...
    parser.add_argument(
        "--MTU", dest="MTU", type=intx, default=3000,
        help="Set MTU [default=%(default)r]")
    return parser


def main(top_block_cls=yehen_try_qpsk, options=None):
    if options is None:
